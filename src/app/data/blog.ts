export const blogData = [
  {
    ...
    summary:
      "Today I was trying to solve some leetcode and found how helpful the leetcode community is. Binary search if learnt properly is such a simple concept, but the places where we can apply it has no bounds. I was trying to solve a problem 'Capacity To Ship Packages Within D Days' and came across a beautiful writeup by a random person on how to approach binary search problems. It had a template that can be used to solve any binary search problem. I was amazed by the simplicity of the template and how it can be applied to solve any binary search problem.",
    learnMoreLinks: [
      {
        title: "the writeup",
